/*
 * Copyright 1990, 1991 by Serge Vakulenko, Moscow, SU.
 *
...
static tgetent (), tnchktc (), tnamatch (), tparm ();
...
static tparm (outp, cp, p1, p2)
register char *outp, *cp;
{
	register c, op;
