...
# For 386bsd
CFLAGS  = -O -DRUS -DTERMIOS
LDFLAGS =

# For Convex under UNIX BSD 4.3
# CFLAGS  = -O -DRUS
# LDFLAGS =
...
sync.o: sc.h
term.o: ctype.h sc.h scr.h key.h
